  ...
  return (
    <div className="px-4 w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor">
      <div className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between">
        ...
        >
          <a href="#home" onClick={handleScroll}><Image className="w-14" src={logo} alt="logo" /></a>
        </motion.div>
        <div className="hidden mdl:inline-flex items-center gap-7">
          ...
          <a href="/assets/SAIM IRSHAD.pdf" target="_blank">
            <motion.button
              initial={{ y: -10, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              ...
              <div className="flex flex-col text-base gap-7 items-center ">
                ...
                <div className="flex flex-  gap-4 items-center">
                  ...
                  <motion.a
                    ...
                    animate={{ y: 0, opacity: 1 }}
                    transition={{ delay: 1, ease: "easeIn" }}
                    href="https://www.youtube.com/channel/UC7yTAgL-2J3cf6hGOD7hR0Q"
                    target="_blank"
                  >
                    <span className="w-10 h-10 text-xl bg-hoverColor rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                      <SlSocialYoutube />
                  ...
                  <motion.a
                    ...
                    animate={{ y: 0, opacity: 1 }}
                    transition={{ delay: 1, ease: "easeIn" }}
                    href="https://www.instagram.com/saimbakars/"
                    target="_blank"
                  >
                    <span className="w-10 h-10 text-xl bg-hoverColor rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                      <SlSocialInstagram />
                  ...
                  <motion.a
                    ...
                    animate={{ y: 0, opacity: 1 }}
                    transition={{ delay: 1, ease: "easeIn" }}
                    href="https://www.facebook.com/saim.irshad.54943/"
                    target="_blank"
                  >
                    <span className="w-10 h-10 text-xl bg-hoverColor rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                      <SlSocialFacebook />
